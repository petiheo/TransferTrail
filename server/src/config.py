...
# Sever's data folder path
SERVER_DATA_PATH = os.path.join(os.path.dirname(__file__), '..', 'data')
UPLOADING_TEMP_PATH = os.path.join(SERVER_DATA_PATH, 'Uploading')

# Ensure temporary directories exist
os.makedirs(UPLOADING_TEMP_PATH, exist_ok=True)
